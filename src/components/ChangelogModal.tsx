            ...
            <div className="space-y-6">
              <div className="relative pl-6 border-l-2 border-rose-200">
                ...
                <h4 className="text-md font-bold text-stone-800 flex items-center gap-2">
                  v1.2.0 <span className="text-xs font-normal text-rose-500 bg-rose-50 px-2 py-0.5 rounded-full">最新版</span>
                </h4>
                ...
                <ul className="list-disc list-inside text-sm text-stone-600 space-y-1.5">
                  ...
                  <li>优化：生成历史与我的收藏列表支持“加载更多”分页加载</li>
                  <li>优化：日期选择器支持按周、按月选择，自动计算并锁定天数</li>
                  <li>优化：生成天数上限放宽至 31 天</li>
                </ul>
              </div>
...
# 4. 访问 http://你的服务器IP:3000 即可使用`}
              ...
              <div className="bg-stone-50 rounded-xl p-5 border border-stone-200">
                ...
                <p className="text-sm text-stone-600 mb-3">如果您使用宝塔面板，可以通过 Node 项目管理器轻松部署。</p>
                <ol className="list-decimal list-inside text-sm text-stone-600 space-y-2">
                  ...
                  <li>打开 Node.js 版本管理器，安装 <strong>Node.js v20 或以上版本</strong>。</li>
                  ...
                  <li>在<strong>网站</strong> -{'>'} <strong>Node项目</strong> 中，点击<strong>添加Node项目</strong>：
                    <ul className="list-disc list-inside ml-6 mt-1 space-y-1 text-stone-500">
                      ...
                      <li>启动选项：自定义启动命令</li>
                      <li>启动命令：<code>npm run start</code> (或 <code>npm run dev</code>)</li>
                      <li>项目端口：<code>3000</code></li>
                      <li>运行用户：www</li>
                    </ul>
                  </li>
                  <li>点击提交，宝塔会自动执行 <code>npm install</code> 并启动项目。</li>
                  <li>在宝塔的<strong>安全</strong>页面，放行 <code>3000</code> 端口。</li>
                  <li>访问 <code>http://你的服务器IP:3000</code> 即可使用。</li>
                </ol>
              </div>
            </div>
          </section>
